...
def main():
  ...
  n2 = Node(coord=np.array([0.,3.]))
  n3 = Node(coord=np.array([3.,3.]))

  # Creating elements
  el0 = ElasTria3(E=25000.,nu=0.3,nodevec=[n0,n1,n2])
  el1 = ElasTria3(E=25000.,nu=0.3,nodevec=[n1,n3,n2])
  
  # Creating BCs
  bc0 = ElasPtBC(E=25000,nu=0.3,nodevec=[n0],type="Displacement",val=[0.,0.])
  bc1 = ElasPtBC(E=25000,nu=0.3,nodevec=[n2],type="DisplacementX",val=[0.,0.])
  ...
  bcForce2 = ElasPtBC(E=25000,nu=0.3,nodevec=[n3],type="Load",val=[1.5,0.])
